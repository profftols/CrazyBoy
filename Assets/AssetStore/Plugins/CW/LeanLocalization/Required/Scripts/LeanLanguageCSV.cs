	...
	public class LeanLanguageCSV_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			BeginDisabled(true);
				switch (tgt.Format)
				{
					case LeanLanguageCSV.FormatType.Legacy: EditorGUILayout.TextArea("Hello = こんにちは // Comment\nCollectItem = アイテム \\n 集めました // Comment here", GUILayout.Height(50)); break;
					case LeanLanguageCSV.FormatType.Comma: EditorGUILayout.TextArea("Hello,こんにちは\nCollectItem,\"アイテム\n集めました\""); break;
					case LeanLanguageCSV.FormatType.Semicolon: EditorGUILayout.TextArea("Hello;こんにちは\nCollectItem;\"アイテム\n集めました\""); break;
				}
			EndDisabled();
