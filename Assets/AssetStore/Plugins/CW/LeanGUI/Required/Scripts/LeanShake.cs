...
namespace Lean.Gui
{
    ...
    public class LeanShake : MonoBehaviour
    {
        ...
        [SerializeField] private Vector3 shakePosition = new(1.0f, 1.0f, 0.0f);
        ...
        [SerializeField] private Vector3 shakeRotation = new(0.0f, 0.0f, 1.0f);
        ...
        protected virtual void Update()
        {
            ...
            if (currentRotation != expectedRotation) localRotation = currentRotation;
            ...
            if (finalRectTransform != null)
            {
                ...
                if (currentPosition != expectedPosition) localPosition = currentPosition;
