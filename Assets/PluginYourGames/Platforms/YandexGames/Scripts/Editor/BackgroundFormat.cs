...
namespace YG.EditorScr.BuildModify
{
    public partial class ModifyBuild
    {
        ...
        {
            var searchCode = @"loadingCover.style.background = ""url('Images/background.png') center / cover"";";
            ...
            {
                var pathImage = BUILD_PATCH + "/Images/background." + format;

                if (File.Exists(pathImage)) File.Delete(pathImage);
            }
        }
    }
}
