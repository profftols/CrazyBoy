...
namespace YG.Insides
{
    public static partial class Langs
    {
        ...
        public const string fullDeletePluginYG =
 "Вы уверены, что хотите полностью удалить PluginYG2 со всеми модулями и другой информацией?";
        public const string protectionAccidentalDeletion = "Защита от случайного удаления";
        public const string fullDeletePluginYGComplete =
 "Закройте Unity и удалите папки PluginYourGames и WebGLTemplate";
        public const string deleteAll = "Удалить всё";
        public const string deleteModule = "Удалить модуль";
        public const string importDependenciesDialog =
 "требуется сначала импортировать зависимости.\nВ проекте отсутствуют следующие модули:";
        public const string importModule = "Импорт модуля";
        public const string importAllModules =
 "Рекомендуется устанавливать только необходимые для вашего проекта модули. Действительно установить все модули?";
        public const string updateWarningDialog =
 "Если процесс обновления не завершится до конца и вы увидите ошибки, то запустите обновление ещё раз.";
        ...
        public const string fullDeletePluginYG =
            "Are you sure you want to completely remove PluginYG2 with all modules and other information?";

        public const string protectionAccidentalDeletion = "Protection against accidental deletion";

        public const string fullDeletePluginYGComplete =
            "Close Unity and delete the PluginYourGames and WebGLTemplate folders";

        public const string deleteAll = "Delete all";
        public const string deleteModule = "Delete package";

        public const string importDependenciesDialog =
            "you need to import dependencies first.\nThe following modules are missing from the project:";

        public const string importModule = "Import module";

        public const string importAllModules =
            "It is recommended to install only the necessary modules for your project. Really install all the modules?";

        public const string updateWarningDialog =
            "If the update process does not complete completely and you see errors, then run the update again.";
