...
namespace YG.EditorScr
{
    public class DocumentationEditor : Editor
    {
        ...
        {
            if (GUILayout.Button(Langs.community, YGEditorStyles.button)) Application.OpenURL(ServerInfo.saveInfo.chat);
        }
        ...
        {
            if (GUILayout.Button(Langs.video, YGEditorStyles.button)) Application.OpenURL(ServerInfo.saveInfo.video);
        }
    }
}