...
namespace YG
{
    public class EventsYG2 : MonoBehaviour
    {
        ...
        public void _HappyTime()
        {
            YG2.optionalPlatform.HappyTime();
        }

        public void _PauseGame(bool pause)
        {
            YG2.PauseGame(pause);
        }

        public void _PauseGameNoEditEventSystem(bool pause)
        {
            YG2.PauseGameNoEditEventSystem(pause);
        }
        ...
        public void _LoadRewardedAdv_optionalPlatform()
        {
        ...
        {
            Execute(EventYG2Type.OpenRewardedAdv);
        }

        private void OnCloseRewaededAdv()
        {
            Execute(EventYG2Type.CloseRewaededAdv);
        }

        private void OnRewardAdv(string id)
        {
            Execute(EventYG2Type.RewardAdv);
        }

        private void OnErrorRewardedAdv()
        {
            Execute(EventYG2Type.ErrorRewardedAdv);
        }
#endif
#if StickyAdv_yg
